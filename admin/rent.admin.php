            ...
            <div class="detailsCust">
                <div class="AllCustomers">
                    ...
                    <?php
                        ...
                        $sql        = 'SELECT 
                                        `rent-list`.`ID_Rent`, `rent-list`.`start`, `rent-list`.`end`, `tariff`.`name`, `class`.`name`, `customer`.`lastname`, `rent-list`.`price`
                                        FROM 
                                        `rent-list`
                                        INNER JOIN 
                                        tariff 
                                        ON 
                                        `rent-list`.`ID_Tariff` = tariff.ID_Tariff
                                        INNER JOIN
                                        class
                                        ON
                                        `rent-list`.`ID_Class` = class.ID_Class
                                        INNER JOIN
                                        customer
                                        ON
                                        `rent-list`.`ID_Customer` = customer.ID_Customer
                                        ';
                        ...
                        echo "<thead><tr>";
                        echo "<td>Leih ID</td><td>Start</td><td>Ende</td><td>Tarif</td><td>Geräte-Art</td><td>Kunde</td><td>Preis</td><td></td>";
                        echo "</tr></thead>";
