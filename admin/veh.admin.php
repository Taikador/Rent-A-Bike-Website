            ...
            <div class="details">
                <div class="AllVeh">
                    ...
                    <?php
                        ...
                        $sql        = 'SELECT 
                                        vehicle.chassis_number, class.name
                                        FROM 
                                        vehicle
                                        INNER JOIN
                                        class
                                        ON
                                        vehicle.ID_Class = class.ID_Class
                                        ';
                        ...
                        echo "<table class='qtable' id='allveh-table'>";
                        echo "<thead><tr>";
                        echo "<td>Rahmennumer</td><td>Art</td>";
                        echo "</tr></thead>";
                ...
                <div class="recentCustomers">
                    ...
                    <div class="input_form">
                        <form class="form_box" action="../inc/veh.inc.php" method="POST">
                            <div class="inputBox w50">
                                <input type= "numeric" name="chassis_number" required>
                            ...
                            <?php
                                ...
                                echo '<select name="class" id="dropDown" required>';
                                echo '<option value="" disabled selected hidden>Art des Fahrzeugs...</option>';
                            ...
                            <?php
                                include_once '../inc/db.inc.php';
                                $query = $conn->query("SELECT * FROM `rent-station`");

                                echo '<select name="station" id="dropDown" required>';
                                echo '<option value="" disabled selected hidden>Station...</option>';
                                while ($row = $query->fetch_assoc()) {
                                    echo "<option value='" . $row['ID_Station'] ."'>" . $row['street'] . ", " . $row['ZIP'] . "</option>";
                                }
                                echo "</select>";
                            ?>
                            </div>
                            <div class="inputBox w50" id="btn">
                                <input type="submit" name="submit" value="Hinzufügen" id="submit">
                            </div>
                        </form>
                    </div>
                </div>
